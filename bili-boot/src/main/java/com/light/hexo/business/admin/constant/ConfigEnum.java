...
public enum ConfigEnum {
    ...
    DESCRIPTION("description", "BillyOrbili,bili","博客描述"),
    KEYWORDS("keywords", "技术博客","博客关键字"),
    LOGO_URL("logo_url", "", "Logo 地址"),
    FAVICON_URL("favicon_url", "", "Favicon 地址"),
    GONGAN_RECORD("gongan_record", "粤公网安备000000号","公安联网备案号"),
    ICP_RECORD("icp_record", "粤ICP备00000000号","工信部备案号"),
    ...
    LICENSE_URL("license_url", "https://aaa/licenses/by-nc-sa/4.0/","文章版权说明地址"),
